...
public:
	...
	Fl_Slider*			m_cubeMapSlider;
	Fl_Check_Button*	m_aaCheckButton;
	Fl_Check_Button*	m_threadCheckBox;
...
private:
	...
	static void cb_rayCountCheckBox(Fl_Widget* o, void* v);
	static void cb_rayCount(Fl_Widget* o, void* v);

	static void cb_threadCheckBox(Fl_Widget* o, void* v);
	static void cb_threader(Fl_Widget* o, void* v);
    //void renderThr(RayTracer* r, int first, int last, int width);
	static void cb_render(Fl_Widget* o, void* v);
	static void cb_stop(Fl_Widget* o, void* v);


	static void cb_cubeMapButton(Fl_Widget* o, void* v);
	static void cb_cubemap(Fl_Widget* o, void* v);
